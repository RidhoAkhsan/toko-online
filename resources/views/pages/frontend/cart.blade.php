        ...
        <div class="bg-gray-100 px-4 py-6 md:p-8 md:rounded-3xl">
          <form action="{{ Route('checkout') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="flex flex-col mb-4">
              ...
              <input data-input type="tel" id="phone-number" name="phone" class="border-gray-200 border rounded-lg px-4 py-2 bg-white text-sm focus:border-blue-200 focus:outline-none" placeholder="Input your phone number" />
            </div>
