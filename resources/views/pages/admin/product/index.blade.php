        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <i class="bi bi-exclamation-circle me-1"></i>
                    Jangan lupa add product galleries
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
                ...
                <table class="table table-striped datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('dashboard.product.gallery.index', $row->id) }}" class="btn btn-info">
                                ...
                                <form action="{{ route('dashboard.product.destroy', $row->id) }}" method="post">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" href="" class="btn btn-danger mt-1">
                                        <i class="bi bi-trash">
                                            Delete
                                        </i>
                                    </button>
